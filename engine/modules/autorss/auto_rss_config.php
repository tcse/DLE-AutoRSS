...
$cfg = array( // Пароль доступа к модулю
	...
	'channel'        => array( // Если задать переменную - канал не будет обрабатываться
		...
		// Скрыть ссылку на источник. Если отметить чекбокс - то ссылка на источник не будет добавляться в конце публикации.
		'showLink'         => '0',

		// Указываются хештеги через запятую. #hash|1,#hash|0 - #hash|1 - новости с хештегом будут добавлены, #hash|0 - новости с хештегом будут пропущены.
		'hashtag'         => '',

		// Данный RSS канал отдает фид в формате Яндекс.Новости
		'yandex_rss'         => '0',),
